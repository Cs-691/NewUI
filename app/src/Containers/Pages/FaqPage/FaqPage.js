...
class FaqPage extends Component {
  ...
  render() {
	...
	<ul className="cd-faq-categories" >
		...
		<li><a className={this.state.selected==='mobile'? 'selected' :'' } onClick={() => this.changeSelected('mobile')} href="#mobile">Daignosis</a></li>
		<li><a className={this.state.selected==='account'? 'selected' :''} onClick={() => this.changeSelected('account')} href="#account">Contribute</a></li>
	...
	<div className="cd-faq-items">
		<ul id="basics" className="cd-faq-group">
			...
			<li className={this.state.show1===true? 'content-visible' :''}>
				<a name='show1' className="cd-faq-trigger" href="#0" onClick={this.showContent}>How can I log in?</a>
				{this.state.show1 && <div className="cd-faq-content::after">
					<p  style={customStyles}> go to nav bar and click on log in button
                    </p></div>
                }
			</li>
			...
			<li className={this.state.show2===true? 'content-visible' :''}>
				...
				{this.state.show2 &&<div className="cd-faq-content::after">
					<p  style= {{ 'line-height': '1.6' }}>  go to nav bar and click on Sign in button</p></div>
                }
			</li>

			<li className={this.state.show3===true? 'content-visible' :''}>
				<a name="show3"className="cd-faq-trigger" href="#0" onClick={this.showContent}>How can you conact us?</a>
				{this.state.show3  && <div className="cd-faq-content::after">
					<p  style={customStyles}>
					go to nav bar and click on Contact button</p>
				</div>
                }
			</li>
			...
			<li className={this.state.show4===true? 'content-visible' :''}>
				...
				{this.state.show4 &&<div className="cd-faq-content::after">
					<p style={customStyles}>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis provident officiis, reprehenderit numquam. Praesentium veritatis eos tenetur magni debitis inventore fugit, magnam, reiciendis, saepe obcaecati ex vero quaerat distinctio velit.</p>
				</div>
                }
			</li>
		</ul> 
		...
		<ul id="mobile" className="cd-faq-group">
			<li className="cd-faq-title"><h2>Daignosis</h2></li>
			<li className={this.state.show5===true? 'content-visible' :''}>
				<a name="show5"className="cd-faq-trigger" href="#0" onClick={this.showContent}>How does prediction work?</a>
				{this.state.show5 && <div className="cd-faq-content::after">
					<p  style={customStyles}>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Impedit quidem delectus rerum eligendi mollitia, repudiandae quae beatae. Et repellat quam atque corrupti iusto architecto impedit explicabo repudiandae qui similique aut iure ipsum quis inventore nulla error aliquid alias quia dolorem dolore, odio excepturi veniam odit veritatis. Quo iure magnam, et cum. Laudantium, eaque non? Tempore nihil corporis cumque dolor ipsum accusamus sapiente aliquid quis ea assumenda deserunt praesentium voluptatibus, accusantium a mollitia necessitatibus nostrum voluptatem numquam modi ab, sint rem.</p>
				</div>
                }
			</li>

			<li className={this.state.show6===true? 'content-visible' :''}>
				<a name="show6"className="cd-faq-trigger" href="#0" onClick={this.showContent}>How can I enter my daily habits like smoking in the system?</a>
			...
			<li className={this.state.show7===true? 'content-visible' :''}>
				<a name="show7"className="cd-faq-trigger" href="#0" onClick={this.showContent}>How do I find remedies for the illness?</a>
